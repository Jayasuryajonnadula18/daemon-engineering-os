...
var automateCmd = &cobra.Command{
	Use:   "automate",
	Short: "Manage automation routines and schedules",
	Long:  `Run, list, schedule, and stop Daemon automation routines. All routines execute through the Automation Engine under Policy Engine control.`,
